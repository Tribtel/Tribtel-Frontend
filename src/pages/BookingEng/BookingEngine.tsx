...
export default function BookingEngine() {
  ...
  //Calculate totals
  //1. Subtotal
  const subtotal = bookingDetails.rooms.reduce((sum, room) => sum + room.price * room.nights, 0);
      ...
      <section className={styles.summarySection}>
        ...
        <div className={styles.costs}>
          <div>
            <span>Subtotal:</span>
            <span>
              {bookingDetails.currency} {subtotal}
            </span>
          </div>
          <div>
            <span>Taxes:</span>
            <span>
              {bookingDetails.currency} {bookingDetails.taxes}
            </span>
          </div>
          <div>
            <span>Discounts:</span>
            <span>
              -{bookingDetails.currency} {bookingDetails.discounts}
            </span>
          </div>
